...
.carFillInner::after{content:"";position:absolute;inset:0;background:linear-gradient(180deg,rgba(255,255,255,.55) 0%,rgba(255,255,255,.14) 24%,rgba(255,255,255,0) 58%);opacity:0;transform:translateY(18%);pointer-events:none;}
...
.carFill.stateA .carFillInner::after{opacity:1;animation:carIdleGlow 2.6s ease-in-out infinite;}
...
@keyframes carIdleGlow{0%,100%{transform:translateY(22%);opacity:.18}50%{transform:translateY(-32%);opacity:.72}}
